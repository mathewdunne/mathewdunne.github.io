...
export default function LinkCard({ icon: Icon, title, url, delay = 0 }: LinkCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Card content */}
      <div className="relative flex items-center gap-4 px-8 py-5 bg-background-card rounded-2xl border border-gray-800 group-hover:border-transparent transition-all duration-300 shadow-lg group-hover:shadow-2xl group-hover:shadow-primary-dark/20">
        {/* Icon */}
        <motion.div
